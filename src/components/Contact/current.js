                ...
                <div>
                    ...
                    <div className="newbody-members">
                        <div className="faculty">
                            <img src="https://res.cloudinary.com/db5gjqx6a/image/upload/v1649086255/Wildbeats-ppl/panchami-modified_wvr9ph.png" className="faculty-img" alt=""/>
                            <h1 className="name">Dr. Panchami V</h1>
